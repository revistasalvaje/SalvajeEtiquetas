...
from .normalizer import normalize_text, find_column, extract_id_from_url
...
def read_data_file():
    ...
    csv_path = os.path.join('app', 'data', 'datos_hoja.csv')
    ...
    try:
        if os.path.exists(csv_path):
            ...
            logger.warning(f"No se encontró el archivo de datos en {csv_path}")
            return pd.DataFrame()
    except Exception as e:
